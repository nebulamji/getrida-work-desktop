export default {
  ...
  installingHermes: "A instalar o GetRida Agent",
  ...
  useExistingHint:
    "Seleccione a pasta que contém a sua instalação existente do Hermes (a pasta que contém a pasta getrida-agent).",
  useExistingInvalid:

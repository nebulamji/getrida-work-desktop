export default {
  ...
  installingHermes: "Instalando GetRida Agent",
  ...
  useExistingHint:
    "Selecciona la carpeta que contiene tu instalación de Hermes existente (la que contiene la carpeta getrida-agent).",
  useExistingInvalid:
